...
\item December 5th, 2025 - Fixed the aircraft dynamics equations as there was a sign error 
\end{enumerate}

\section*{Changes Needed}

\begin{enumerate}[itemsep=-5pt]
\item Move all of these items to Github issues so that they can be tracked easier
