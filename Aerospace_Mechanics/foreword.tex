...
\item September 7-8th, 2025 - Used Github's copilot on the Mobile App to create the first order example of a differential equation. I then used VS code to finish editing it since there were a few errors.
\end{enumerate}
