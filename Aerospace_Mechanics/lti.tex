...
\subsection{Example First Order System Formulation}

A first order system undergoing free motion will have dynamics that look like this
\begin{equation} 
\dot{q} + \sigma q = \sigma f
\end{equation}
where q is a generalized coordinate, $\sigma$ is the inverse of the time constant $tau$, and f is the forcing function. Examples of these types of systems in include thermistors, servos, and velocity equations for system dynamics. 
...
\end{equation}
where $q$ is a generalized coordinate, $\sigma$ is the inverse of the time constant $tau$,f is th forcing function,
