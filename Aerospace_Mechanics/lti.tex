...
\end{equation}
results in the same equation as equation \ref{e:second_order} provided you subsitute $\alpha$ with the generalized q coordinate.
...
\hl{This section is incomplete and will be finished later.}
