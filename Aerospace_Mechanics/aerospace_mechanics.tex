...
the motor will burn to extinction. 
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{ACME Interface Diagram from the Gemini Spacecraft}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{New Horizons Interface Diagram}
\end{figure}
...
materials, energy, power, data, and information are examples of items.
...
branched, and concurrent flow of the system.
...
determine position is imperative\cite{cassidis}.  
