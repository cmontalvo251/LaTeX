...
\section{Part 1 Purchase Equipment and Download Python IDE for Desktop}
...
bundled all components together. At the time of this writing the links
below are stil valid.

\begin{enumerate}[itemsep=-5pt]
\item \href{https://www.tangiblesthatteach.com/product-page/instrumentation-kit-for-me-316}{PURCHASE
KIT AT TANGIBLES THAT TEACH}
\item \href{https://youtu.be/6sNNQrhnzLE}{Unboxing video on Youtube}
\end{enumerate}

When you get your kit familiarize yourself with all of the
components. I created an \href{https://youtu.be/6sNNQrhnzLE}{unboxing video on Youtube}
 for you to take a look. Below is also a photo of all the components.
\begin{figure}[H]
  \begin{center}
...
\subsection{List of Items in Kit}

The kit above comes with the following items. It is possible for you
to purchase all items individually but it's possible you may end up
getting the wrong component or paying more on shipping. Please
exercise caution if you plan on purchasing everything individually.
\begin{enumerate}[itemsep=-5pt]
...
\subsection{Part 1 Assignment}
Purchase the required instrumentation kit and create a document with the following items:
\begin{enumerate}[itemsep=-5pt]
\item A receipt of ALL of your purchases that shows you have purchased all items in the kit or just the kit itself from Tangibles that Teach - 50\%
...
\section{Part 2 Download Python for Desktop}
