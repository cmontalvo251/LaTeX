...
\begin{enumerate}[itemsep=-5pt]
\item Only one servo will be given for each group. You must give it back at the end of Part 3 in order to receive credit for any of these assignments. 
\item Returned Servo after Part3? - Pass/Fail
