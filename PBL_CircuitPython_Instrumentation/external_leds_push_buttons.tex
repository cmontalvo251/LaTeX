...
\item The USB port from your computer is 5V. The DC to DC converter on the CPX/CPB converts that 5V to 3.3V. Compute the Gain ($G$) for this converter both in magnitude and in $dB$. - 10\%
