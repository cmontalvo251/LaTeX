...
\begin{enumerate}[itemsep=-5pt]
  \item Laptop
  \item \href{https://codewith.mu/en/download}{Mu}
  \item CPX (or CPB) \href{https://circuitpython.org}{UF2 File}
  \item CPX(or CPB)
...
\begin{enumerate}[itemsep=-5pt]
\item Learn how to setup your Circuit Playground Express
\item Learn how to install Mu 
\item Learn how to code with Mu
\item Learn about hardware and software debugging
\item Learn the difference between Python and CircuitPython
\end{enumerate}
