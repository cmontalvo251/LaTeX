...
\item December 30th, 2020 - Added datetime to title page. Added
  section headers to RC aircraft design. Wrote text all the way to
  airfoil selection. 
\end{enumerate}
...
\begin{enumerate}[itemsep=-5pt]
\item Need a section on how to design an RC aircraft
\end{enumerate}
...
appreciation for what goes into aircraft design.
...
centerline of the vehicle and y=b/2 is the wingtip on the right side. 
...
\subsection{Wing Cube Loading and Thrust to Weight Ratio}
...
\subsection{Takeoffs are Optional, Landings are Not}
